...
class Inmp441Max98357aFastLED16 : public Device
{
public:
  Inmp441Max98357aFastLED16() = default;
...
void Inmp441Max98357aFastLED16::init()
{
...
void Inmp441Max98357aFastLED16::updateColors(StateColors colors)
{
...
void Inmp441Max98357aFastLED16::animate(StateColors colors, int mode)
{
  switch (mode) {
...
void Inmp441Max98357aFastLED16::animateRunning(StateColors colors)
{
...
void Inmp441Max98357aFastLED16::animateBlinking(StateColors colors)
{
...
void Inmp441Max98357aFastLED16::setWriteMode(int sampleRate, int bitDepth, int numChannels)
{
  if (sampleRate > 0) {
...
void Inmp441Max98357aFastLED16::writeAudio(uint8_t *data, size_t size, size_t *bytes_written)
{
  i2s_write(SPK_I2S_PORT, data, size, bytes_written, portMAX_DELAY);
}

bool Inmp441Max98357aFastLED16::readAudio(uint8_t *data, size_t size)
{
...
void Inmp441Max98357aFastLED16::updateBrightness(int brightness)
{
  FastLED.setBrightness(brightness);
}

void Inmp441Max98357aFastLED16::setGain(uint16_t gain)
{
  m_gain = gain;
}